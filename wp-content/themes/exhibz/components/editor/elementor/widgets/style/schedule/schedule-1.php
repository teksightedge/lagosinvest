         ...
         <div class="col-lg-6 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="500ms">
            <div class="ts-schedule-info mb-70">
               <ul class="nav nav-tabs" role="tablist">
                  ...
                  <?php if( $i == 1 ){ ?>
                  <li class="nav-item">
                     <a class="active" title="Click Me" href="<?php echo esc_attr("#date".$this->get_id().$i); ?>" role="tab" data-toggle="tab">
                  ...
                  <?php }else { ?>  
                  <li class="nav-item">
                     <a  title="Click Me" href="<?php echo esc_attr("#date".$this->get_id().$i); ?>" role="tab" data-toggle="tab">
                        <h3><?php echo get_the_title($postnav->ID) ?></h3>
         ...
         <div class="col-lg-12">
            <div class="tab-content schedule-tabs">
               <?php 
                  ...
                  ?>  
               <?php if($j==1){ ?>  
               <div role="tabpanel" class="tab-pane active" id="<?php echo "date".$this->get_id().$j; ?>">

        ...
        <div class="etn-row etn-item-row">
            <div class="col-item etn-qty-field etn-col-lg-3">
                ...
                <input id="etn_product_qty" class="attr-form-control etn-event-form-qty etn_product_qty" name="quantity"
                    type="number" value="1" min="1" data-left_ticket="<?php echo esc_html($etn_left_tickets); ?>"
                    data-invalid_qty_text="<?php echo esc_html__("Invalid Qty", 'exhibz');?>" />
            </div>
            ...
            <div class="col-item etn-col-lg-3">
                ...
                <?php
                        ...
                        if (!isset($event_options["etn_purchase_login_required"]) || (isset($event_options["etn_purchase_login_required"]) && is_user_logged_in())) {
                            ?>
                <input name="submit" class="etn-btn etn-primary etn-add-to-cart-block" type="submit"

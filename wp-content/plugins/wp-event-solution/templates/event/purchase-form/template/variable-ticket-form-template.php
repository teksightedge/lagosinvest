...
<form method="post" class="etn-event-form-parent etn-ticket-variation"  data-etn_uid="<?php echo esc_html($unique_id); ?>" data-decimal-number-points="<?php echo esc_attr($price_decimal); ?>">
										...
										<div class="etn-single-ticket-item">
												...
												<div class="etn-ticket-price-body <?php echo esc_attr($stock_outClass) ?>">
														<div class="ticket-price-item etn-ticket-price">
																...
																<strong>
																		<?php
																		echo esc_html( \Etn\Core\Event\Helper::instance()->get_currency() );
																		echo number_format( (float) $value['etn_ticket_price'], $price_decimal, '.','' );
																		?>
														...
														<div class="ticket-price-item etn-subtotal" data-subtotal="<?php esc_attr_e(number_format( (float) $value['etn_ticket_price'], $price_decimal, '.','' ));?>">
																<label><?php echo esc_html__("Sub Total :","eventin");?></label>
																<strong>
																		<?php echo esc_html( \Etn\Core\Event\Helper::instance()->get_currency() ); ?>
																		<span class="_sub_total_<?php echo floatval( $key ); ?>">0</span>
																</strong>
														</div>
												</div>

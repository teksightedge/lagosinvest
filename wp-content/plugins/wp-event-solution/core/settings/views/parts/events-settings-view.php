                    ...
                    <div class="etn-settings-tab-content">
                        <div class="etn-settings-tab" id="events-details">                           
                            ...
                            <div class="attr-form-group etn-label-item">
                                ...
                                <div class="etn-meta">
                                    <input id="checked_hide_speakers_from_details" type="checkbox" <?php echo esc_html($checked_hide_speaker_from_details); ?> class="etn-admin-control-input etn_hide_speaker_from_details" name="etn_hide_speaker_from_details" />
                                    <label for="checked_hide_speakers_from_details" class="etn_switch_button_label"></label>
                                </div>
                            </div>
                            ...
                            <div class="attr-form-group etn-label-item">
                                ...
                                <div class="etn-meta">
                                    <input id="checked_hide_calendar_from_details" type="checkbox" <?php echo esc_html($checked_hide_calendar_from_details); ?> class="etn-admin-control-input" name="checked_hide_calendar_from_details" />
                                    <label for="checked_hide_calendar_from_details" class="etn_switch_button_label"></label>
                                </div>
                            </div>
                            <?php
                        ...
                        <div class="etn-settings-tab" id="attendee-settings">
                            ...
                            <div class="attr-form-group etn-label-item">
                                ...
                                <div class="etn-meta">
                                    ...
                                    <select value='style-1' id="attendee_ticket_style" name='attendee_ticket_style' class="etn-setting-input attr-form-control etn-settings-select">
                                        ...
                                        <option <?php echo esc_attr($disabled) ?> value='style-2' <?php echo esc_html( selected( $attendee_ticket_style, 'style-2', false ) ); ?>> <?php echo esc_html( 'Style 2 (Pro)', 'eventin' ); ?> </option>
                                    </select>
                                </div>
                            </div>

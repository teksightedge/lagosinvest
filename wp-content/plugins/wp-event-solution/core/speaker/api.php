...
class Api extends \Etn\Base\Api_Handler {
    ...
    public function get_speakers() {
        ...
        $category       = isset( $request['category'] ) ? sanitize_text_field( $request['category'] ) : 'speaker';
    ...
    public function delete_speakers() {
        ...
        foreach ( $post_ids as $post_id ) {
            ...
            if ( 'etn-speaker' != $post->post_type || $user_id != $post->parent ) {
    ...
    private function save_post() {
        ...
        $thumbnail_id = ! empty( $speaker->thumbnail_id ) ? $speaker->thumbnail_id : 0;
